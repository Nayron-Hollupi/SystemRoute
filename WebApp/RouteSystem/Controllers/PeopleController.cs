...
namespace RouteSystem.Controllers
{
    ...
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Status,Id")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Status,Id")] Person person)
        {
